...
shd_time = datetime.datetime(now.year, now.month, now.day, 12,36,0)
...
if __name__ == "__main__":
    ...
    shd_timer = shutdownTimer()

    #The main thread must be able to abort the shutdown
    warningTimer(shd_timer)